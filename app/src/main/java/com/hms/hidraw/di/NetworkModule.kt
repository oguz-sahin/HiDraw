...
import com.hms.hidraw.network.interceptor.HeaderInterceptor
import com.hms.hidraw.network.interceptor.NetworkConnectionInterceptor
import com.hms.hidraw.network.service.DrawService
import com.hms.hidraw.network.service.UserService
...
object NetworkModule {
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl(com.hms.hidraw.BuildConfig.BASE_URL)
            .client(okHttpClient)
    ...
    fun provideHttpLoggingInterceptor(): Interceptor {
        return HttpLoggingInterceptor().apply {
            level = if (com.hms.hidraw.BuildConfig.DEBUG) HttpLoggingInterceptor.Level.BODY
